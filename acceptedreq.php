      ...
      <div class="col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i>Accepted Requests</h3>
                            </div>
                            <div class="panel-body">
                             <?php
if ($_SESSION['staff']) {
	$staffId=$_SESSION['staff'];
	$query3 = "SELECT left(department,10) as dep FROM staff WHERE staffId = '$staffId'";
	$result3 = mysql_query($query3);
	$row=mysql_fetch_array($result3);
	$dep = $row['dep'];
$query="SELECT * FROM request WHERE department LIKE '$dep%' AND status LIKE 'Accepted'";
...
echo "</table>";
	...
	echo "<script type='text/javascript'>alert('No more accepted request(s)'); window.location.href = 'staff_logged.php';</script>";
}
}
?>
&nbsp;
<form action="clear.php" method="POST" role="form" class="form-horizontal">
