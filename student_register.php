...
<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <div class="col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i>Student Registration</h3>
                            </div>
  ...
  $address=htmlentities($_POST['address']);
    ...
    if (!empty($reg_no) && !empty($password)&& !empty($f_name)&&!empty($l_name)&& !empty($dob)&& !empty($gender)&& !empty($department)&&!empty($phone_no)&& !empty($email)&&!empty($address)) {
      ...
      die('Error: ' . mysql_error());
        ...
        echo "<script type='text/javascript'>alert('You have registered successfully.You can now login');window.location.href='student_login.php'</script>";
  }
  }
   ...
   ?>
       ...
       <form action="student_register.php" method="POST" class="form-horizontal" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control"  pattern="[a-zA-Z]{1,}" name="f_name" placeholder="First name">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="l_name">Last name:</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" pattern="[a-zA-Z]{1,}" name="l_name" placeholder="Last name">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" pattern="^(([0-9]*)|(([0-9]*)\.([0-9]*)))$"  m maxlength="10" name="phone_no" placeholder="Enter phone number">
    </div>
  </div>
  <div class="form-group">
